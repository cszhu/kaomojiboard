# Privacy Policy — kaomojiBoard

_Last updated: August 17, 2026_

kaomojiBoard does not collect, transmit, sell, or share any personal information. Full stop.
...
This count is stored using Chrome's `chrome.storage.sync` API. That means it lives in your
own browser profile and, if you have Chrome Sync turned on, syncs between your own signed-in
Chrome installations through your own Google account. **The developer has no access to it and
never receives a copy of it.**

Nothing else is stored. The extension does not record what you paste, where you paste it,
what pages you visit, or anything about you.

## Network activity

None. kaomojiBoard makes no network requests of any kind. Every asset it uses — the kaomoji
